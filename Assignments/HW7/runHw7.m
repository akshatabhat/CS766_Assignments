...
grid_MN = [20, 20];              % Number of rows and cols in the grid
...
search_half_window_size = 25;   % Half size of the search window
template_half_window_size = 15; % Half size of the template window 
grid_MN = [20, 20];              % Number of rows and cols in the grid
...
% to specify the target of interest
%tracking_params.rect = chooseTarget(data_params);
tracking_params.rect = [152 128 49 51];

% Half size of the search window
tracking_params.search_half_window_size = 7;
% Number of bins in the color histogram
tracking_params.bin_n = 200;           
...
% to specify the target of interest
%tracking_params.rect = chooseTarget(data_params);
tracking_params.rect = [270 170 47 120];
% Half size of the search window
tracking_params.search_half_window_size = 10;
% Number of bins in the color histogram
tracking_params.bin_n = 300;           
